...
class TripNoteModel {
  ...
  @override
  String toString() =>
      'TripNoteModel[id=$id, tripId=$tripId, content=$content, createdBy=$createdBy, createdAt=$createdAt, isPrivate=$isPrivate, metadata=$metadata, extra=$extra]';
  ...
  static List<TripNoteModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <TripNoteModel>[]
          : json
              .map((v) => TripNoteModel.fromJson(v))
  ...
  static Map<String, TripNoteModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = TripNoteModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of TripNoteModel-objects as value to a dart map
  static Map<String, List<TripNoteModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = TripNoteModel.listFromJson(v,
