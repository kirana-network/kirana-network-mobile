...
class TripClientModel {
  ...
  @override
  String toString() =>
      'TripClientModel[organizationId=$organizationId, id=$id, address=$address, location=$location, firstName=$firstName, lastName=$lastName, homePhone=$homePhone, cellPhone=$cellPhone, email=$email, extra=$extra, options=$options, notes=$notes]';
  ...
  static List<TripClientModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <TripClientModel>[]
          : json
              .map((v) => TripClientModel.fromJson(v))
  ...
  static Map<String, TripClientModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = TripClientModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of TripClientModel-objects as value to a dart map
  static Map<String, List<TripClientModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = TripClientModel.listFromJson(v,
