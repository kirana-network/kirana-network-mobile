...
class ListOfOrganizationsModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is ListOfOrganizationsModel &&
  ...
  @override
  String toString() =>
      'ListOfOrganizationsModel[records=$records, total=$total]';
  ...
  static ListOfOrganizationsModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : ListOfOrganizationsModel(
  ...
  static List<ListOfOrganizationsModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListOfOrganizationsModel>[]
          : json
              .map((v) => ListOfOrganizationsModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ListOfOrganizationsModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ListOfOrganizationsModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = ListOfOrganizationsModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListOfOrganizationsModel-objects as value to a dart map
  static Map<String, List<ListOfOrganizationsModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListOfOrganizationsModel.listFromJson(v,
