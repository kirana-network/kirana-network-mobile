...
class OrganizationModel {
  ...
  @override
  String toString() =>
      'OrganizationModel[address=$address, updatedAt=$updatedAt, createdAt=$createdAt, createdBy=$createdBy, ownerUserProfileId=$ownerUserProfileId, updatedBy=$updatedBy, id=$id, location=$location, name=$name, hasActiveSubscription=$hasActiveSubscription, extra=$extra]';
    ...
    bool growable,
      ...
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <OrganizationModel>[]
          : json
              .map((v) => OrganizationModel.fromJson(v))
  ...
  static Map<String, OrganizationModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = OrganizationModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of OrganizationModel-objects as value to a dart map
  static Map<String, List<OrganizationModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = OrganizationModel.listFromJson(v,
