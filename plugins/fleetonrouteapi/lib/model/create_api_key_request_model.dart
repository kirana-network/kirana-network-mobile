...
class CreateApiKeyRequestModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is CreateApiKeyRequestModel &&
  ...
  @override
  String toString() =>
      'CreateApiKeyRequestModel[userProfileId=$userProfileId, organizationId=$organizationId, version=$version, extra=$extra]';
  ...
  static CreateApiKeyRequestModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : CreateApiKeyRequestModel(
  ...
  static List<CreateApiKeyRequestModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <CreateApiKeyRequestModel>[]
          : json
              .map((v) => CreateApiKeyRequestModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, CreateApiKeyRequestModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, CreateApiKeyRequestModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = CreateApiKeyRequestModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of CreateApiKeyRequestModel-objects as value to a dart map
  static Map<String, List<CreateApiKeyRequestModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = CreateApiKeyRequestModel.listFromJson(v,
