...
class ListOfInvitationsModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is ListOfInvitationsModel &&
  ...
  static ListOfInvitationsModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : ListOfInvitationsModel(
  ...
  static List<ListOfInvitationsModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListOfInvitationsModel>[]
          : json
              .map((v) => ListOfInvitationsModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ListOfInvitationsModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ListOfInvitationsModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = ListOfInvitationsModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListOfInvitationsModel-objects as value to a dart map
  static Map<String, List<ListOfInvitationsModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListOfInvitationsModel.listFromJson(v,
