...
class TripOptionsModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TripOptionsModel &&
  ...
  @override
  String toString() => 'TripOptionsModel[enableNotifications=$enableNotifications, requireProofOfDelivery=$requireProofOfDelivery]';
  ...
  static List<TripOptionsModel> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <TripOptionsModel>[]
      : json.map((v) => TripOptionsModel.fromJson(v)).toList(growable: true == growable);

  static Map<String, TripOptionsModel> mapFromJson(Map<String, dynamic> json) {
    final map = <String, TripOptionsModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = TripOptionsModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of TripOptionsModel-objects as value to a dart map
  static Map<String, List<TripOptionsModel>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<TripOptionsModel>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = TripOptionsModel.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
