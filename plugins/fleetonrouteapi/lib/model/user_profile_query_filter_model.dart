...
class UserProfileQueryFilterModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is UserProfileQueryFilterModel &&
  ...
  @override
  String toString() =>
      'UserProfileQueryFilterModel[lastName=$lastName, firstName=$firstName, email=$email, organizationId=$organizationId, createdBy=$createdBy, updatedBy=$updatedBy, ids=$ids]';
  ...
  static UserProfileQueryFilterModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : UserProfileQueryFilterModel(
  ...
  static List<UserProfileQueryFilterModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <UserProfileQueryFilterModel>[]
          : json
              .map((v) => UserProfileQueryFilterModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, UserProfileQueryFilterModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, UserProfileQueryFilterModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = UserProfileQueryFilterModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of UserProfileQueryFilterModel-objects as value to a dart map
  static Map<String, List<UserProfileQueryFilterModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = UserProfileQueryFilterModel.listFromJson(v,
