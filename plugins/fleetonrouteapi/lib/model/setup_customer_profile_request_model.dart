...
class SetupCustomerProfileRequestModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is SetupCustomerProfileRequestModel &&
          other.type == type &&
  ...
  @override
  String toString() =>
      'SetupCustomerProfileRequestModel[type=$type, userProfileId=$userProfileId]';
  ...
  static SetupCustomerProfileRequestModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : SetupCustomerProfileRequestModel(
              type: SetupCustomerProfileRequestModelTypeEnum.fromJson(
                  json[r'type']),
              userProfileId: json[r'userProfileId'],
            );

  static List<SetupCustomerProfileRequestModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <SetupCustomerProfileRequestModel>[]
          : json
              .map((v) => SetupCustomerProfileRequestModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, SetupCustomerProfileRequestModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, SetupCustomerProfileRequestModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = SetupCustomerProfileRequestModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of SetupCustomerProfileRequestModel-objects as value to a dart map
  static Map<String, List<SetupCustomerProfileRequestModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = SetupCustomerProfileRequestModel.listFromJson(v,
...
class SetupCustomerProfileRequestModelTypeEnum {
  ...
  static List<SetupCustomerProfileRequestModelTypeEnum> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ? null
              : <SetupCustomerProfileRequestModelTypeEnum>[]
          : json
              .map((value) =>
                  SetupCustomerProfileRequestModelTypeEnum.fromJson(value))
              .toList(growable: true == growable);
}
...
class SetupCustomerProfileRequestModelTypeEnumTypeTransformer {
  ...
  factory SetupCustomerProfileRequestModelTypeEnumTypeTransformer() =>
      _instance ??= SetupCustomerProfileRequestModelTypeEnumTypeTransformer._();
  ...
  SetupCustomerProfileRequestModelTypeEnum decode(dynamic data,
      {bool allowNull}) {
    switch (data) {
      case r'STRIPE':
        return SetupCustomerProfileRequestModelTypeEnum.STRIPE;
      case r'SHOPIFY':
        return SetupCustomerProfileRequestModelTypeEnum.SHOPIFY;
      case r'OFFLINE':
        return SetupCustomerProfileRequestModelTypeEnum.OFFLINE;
      default:
        if (allowNull == false) {
