...
class ListOfApiKeysModel {
  ...
  static List<ListOfApiKeysModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListOfApiKeysModel>[]
          : json
              .map((v) => ListOfApiKeysModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ListOfApiKeysModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ListOfApiKeysModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = ListOfApiKeysModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListOfApiKeysModel-objects as value to a dart map
  static Map<String, List<ListOfApiKeysModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListOfApiKeysModel.listFromJson(v,
