...
class GPSUnitModel {
  ...
  @override
  String toString() =>
      'GPSUnitModel[id=$id, associatedUserProfileId=$associatedUserProfileId, deviceName=$deviceName, lastUpdatedAt=$lastUpdatedAt, locationAccuracy=$locationAccuracy, locationLatitude=$locationLatitude, locationLongitude=$locationLongitude, extra=$extra]';
  ...
  static List<GPSUnitModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, GPSUnitModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = GPSUnitModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of GPSUnitModel-objects as value to a dart map
  static Map<String, List<GPSUnitModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = GPSUnitModel.listFromJson(v,
