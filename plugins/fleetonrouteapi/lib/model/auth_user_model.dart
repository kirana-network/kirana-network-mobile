...
class AuthUserModel {
  ...
  @override
  String toString() =>
      'AuthUserModel[refreshToken=$refreshToken, displayName=$displayName, email=$email, emailVerified=$emailVerified, idToken=$idToken, uid=$uid]';
  ...
  static List<AuthUserModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <AuthUserModel>[]
          : json
              .map((v) => AuthUserModel.fromJson(v))
  ...
  static Map<String, AuthUserModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = AuthUserModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of AuthUserModel-objects as value to a dart map
  static Map<String, List<AuthUserModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = AuthUserModel.listFromJson(v,
