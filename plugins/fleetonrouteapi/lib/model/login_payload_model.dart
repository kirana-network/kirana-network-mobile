...
class LoginPayloadModel {
  ...
  @override
  String toString() =>
      'LoginPayloadModel[username=$username, password=$password]';
  ...
  static List<LoginPayloadModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <LoginPayloadModel>[]
          : json
              .map((v) => LoginPayloadModel.fromJson(v))
  ...
  static Map<String, LoginPayloadModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = LoginPayloadModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of LoginPayloadModel-objects as value to a dart map
  static Map<String, List<LoginPayloadModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = LoginPayloadModel.listFromJson(v,
