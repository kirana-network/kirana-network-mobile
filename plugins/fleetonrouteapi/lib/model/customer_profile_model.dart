...
class CustomerProfileModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is CustomerProfileModel &&
     other.type == type &&
     other.id == id &&
  ...
  @override
  String toString() => 'CustomerProfileModel[type=$type, id=$id, userProfileId=$userProfileId, stripe=$stripe, offline=$offline]';
  ...
  static CustomerProfileModel fromJson(Map<String, dynamic> json) => json == null
    ? null
    : CustomerProfileModel(
  ...
  static List<CustomerProfileModel> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <CustomerProfileModel>[]
      : json.map((v) => CustomerProfileModel.fromJson(v)).toList(growable: true == growable);

  static Map<String, CustomerProfileModel> mapFromJson(Map<String, dynamic> json) {
    final map = <String, CustomerProfileModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = CustomerProfileModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of CustomerProfileModel-objects as value to a dart map
  static Map<String, List<CustomerProfileModel>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<CustomerProfileModel>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = CustomerProfileModel.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
...
class CustomerProfileModelTypeEnum {
  ...
  static List<CustomerProfileModelTypeEnum> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <CustomerProfileModelTypeEnum>[]
      : json
...
class CustomerProfileModelTypeEnumTypeTransformer {
  ...
  factory CustomerProfileModelTypeEnumTypeTransformer() => _instance ??= CustomerProfileModelTypeEnumTypeTransformer._();
  ...
  CustomerProfileModelTypeEnum decode(dynamic data, {bool allowNull}) {
    switch (data) {
      case r'STRIPE': return CustomerProfileModelTypeEnum.STRIPE;
      case r'SHOPIFY': return CustomerProfileModelTypeEnum.SHOPIFY;
      case r'OFFLINE': return CustomerProfileModelTypeEnum.OFFLINE;
      default:
        if (allowNull == false) {
