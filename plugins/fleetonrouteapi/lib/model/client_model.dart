...
class ClientModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ClientModel &&
  ...
  @override
  String toString() => 'ClientModel[organizationId=$organizationId, id=$id, address=$address, location=$location, firstName=$firstName, lastName=$lastName, homePhone=$homePhone, cellPhone=$cellPhone, email=$email, extra=$extra, notes=$notes, createdBy=$createdBy, updatedBy=$updatedBy, createdAt=$createdAt, updatedAt=$updatedAt, options=$options]';
  ...
  static List<ClientModel> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <ClientModel>[]
      : json.map((v) => ClientModel.fromJson(v)).toList(growable: true == growable);

  static Map<String, ClientModel> mapFromJson(Map<String, dynamic> json) {
    final map = <String, ClientModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = ClientModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ClientModel-objects as value to a dart map
  static Map<String, List<ClientModel>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ClientModel>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ClientModel.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
