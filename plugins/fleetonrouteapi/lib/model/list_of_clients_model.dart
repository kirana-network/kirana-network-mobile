...
class ListOfClientsModel {
  ...
  static List<ListOfClientsModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListOfClientsModel>[]
          : json
              .map((v) => ListOfClientsModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ListOfClientsModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ListOfClientsModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = ListOfClientsModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListOfClientsModel-objects as value to a dart map
  static Map<String, List<ListOfClientsModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListOfClientsModel.listFromJson(v,
