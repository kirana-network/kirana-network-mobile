...
class ApiKeyModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApiKeyModel &&
     other.keyId == keyId &&
     other.token == token &&
  ...
  @override
  String toString() => 'ApiKeyModel[keyId=$keyId, token=$token, userProfileId=$userProfileId, organizationId=$organizationId, version=$version, createdBy=$createdBy, createdAt=$createdAt, extra=$extra]';
  ...
  static List<ApiKeyModel> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <ApiKeyModel>[]
      : json.map((v) => ApiKeyModel.fromJson(v)).toList(growable: true == growable);

  static Map<String, ApiKeyModel> mapFromJson(Map<String, dynamic> json) {
    final map = <String, ApiKeyModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = ApiKeyModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ApiKeyModel-objects as value to a dart map
  static Map<String, List<ApiKeyModel>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ApiKeyModel>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ApiKeyModel.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
