...
class ListOfUserProfilesModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is ListOfUserProfilesModel &&
  ...
  @override
  String toString() =>
      'ListOfUserProfilesModel[records=$records, total=$total]';
  ...
  static ListOfUserProfilesModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : ListOfUserProfilesModel(
  ...
  static List<ListOfUserProfilesModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListOfUserProfilesModel>[]
          : json
              .map((v) => ListOfUserProfilesModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ListOfUserProfilesModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ListOfUserProfilesModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = ListOfUserProfilesModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListOfUserProfilesModel-objects as value to a dart map
  static Map<String, List<ListOfUserProfilesModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListOfUserProfilesModel.listFromJson(v,
