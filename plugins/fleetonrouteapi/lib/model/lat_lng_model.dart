...
class LatLngModel {
  ...
  static LatLngModel fromJson(Map<String, dynamic> json) => json == null
      ...
      : LatLngModel(
          latitude:
              json[r'latitude'] == null ? null : json[r'latitude'].toDouble(),
          longitude:
              json[r'longitude'] == null ? null : json[r'longitude'].toDouble(),
        );

  static List<LatLngModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
  ...
  static Map<String, LatLngModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = LatLngModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of LatLngModel-objects as value to a dart map
  static Map<String, List<LatLngModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = LatLngModel.listFromJson(v,
