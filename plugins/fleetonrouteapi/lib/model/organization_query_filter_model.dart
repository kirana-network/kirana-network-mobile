...
class OrganizationQueryFilterModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is OrganizationQueryFilterModel &&
          other.ids == ids &&
          other.name == name &&
  ...
  @override
  String toString() =>
      'OrganizationQueryFilterModel[ids=$ids, name=$name, userProfileId=$userProfileId, address=$address]';
  ...
  static OrganizationQueryFilterModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : OrganizationQueryFilterModel(
              ids: json[r'ids'] == null
  ...
  static List<OrganizationQueryFilterModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <OrganizationQueryFilterModel>[]
          : json
              .map((v) => OrganizationQueryFilterModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, OrganizationQueryFilterModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, OrganizationQueryFilterModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = OrganizationQueryFilterModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of OrganizationQueryFilterModel-objects as value to a dart map
  static Map<String, List<OrganizationQueryFilterModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = OrganizationQueryFilterModel.listFromJson(v,
