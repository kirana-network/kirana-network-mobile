...
class TripNoteMetadataModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is TripNoteMetadataModel &&
  ...
  @override
  String toString() =>
      'TripNoteMetadataModel[location=$location, details=$details]';
  ...
  static TripNoteMetadataModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : TripNoteMetadataModel(
  ...
  static List<TripNoteMetadataModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <TripNoteMetadataModel>[]
          : json
              .map((v) => TripNoteMetadataModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, TripNoteMetadataModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, TripNoteMetadataModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = TripNoteMetadataModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of TripNoteMetadataModel-objects as value to a dart map
  static Map<String, List<TripNoteMetadataModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = TripNoteMetadataModel.listFromJson(v,
