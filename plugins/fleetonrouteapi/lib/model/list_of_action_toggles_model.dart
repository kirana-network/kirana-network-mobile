...
class ListOfActionTogglesModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is ListOfActionTogglesModel &&
  ...
  @override
  String toString() =>
      'ListOfActionTogglesModel[records=$records, total=$total]';
  ...
  static ListOfActionTogglesModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : ListOfActionTogglesModel(
  ...
  static List<ListOfActionTogglesModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListOfActionTogglesModel>[]
          : json
              .map((v) => ListOfActionTogglesModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, ListOfActionTogglesModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, ListOfActionTogglesModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = ListOfActionTogglesModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListOfActionTogglesModel-objects as value to a dart map
  static Map<String, List<ListOfActionTogglesModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListOfActionTogglesModel.listFromJson(v,
