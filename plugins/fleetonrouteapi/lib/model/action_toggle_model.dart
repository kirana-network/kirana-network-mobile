...
class ActionToggleModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ActionToggleModel &&
     other.action == action &&
  ...
  static List<ActionToggleModel> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <ActionToggleModel>[]
      : json.map((v) => ActionToggleModel.fromJson(v)).toList(growable: true == growable);

  static Map<String, ActionToggleModel> mapFromJson(Map<String, dynamic> json) {
    final map = <String, ActionToggleModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) => map[key] = ActionToggleModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ActionToggleModel-objects as value to a dart map
  static Map<String, List<ActionToggleModel>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<ActionToggleModel>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ActionToggleModel.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
