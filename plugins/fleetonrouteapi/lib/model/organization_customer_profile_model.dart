...
class OrganizationCustomerProfileModel {
  ...
  bool operator ==(Object other) =>
      ...
      other is OrganizationCustomerProfileModel &&
          other.type == type &&
          other.id == id &&
  ...
  @override
  String toString() =>
      'OrganizationCustomerProfileModel[type=$type, id=$id, userProfileId=$userProfileId, stripe=$stripe, offline=$offline, organizationId=$organizationId]';
  ...
  static OrganizationCustomerProfileModel fromJson(Map<String, dynamic> json) =>
      json == null
          ? null
          : OrganizationCustomerProfileModel(
              type: OrganizationCustomerProfileModelTypeEnum.fromJson(
                  json[r'type']),
              id: json[r'id'],
  ...
  static List<OrganizationCustomerProfileModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <OrganizationCustomerProfileModel>[]
          : json
              .map((v) => OrganizationCustomerProfileModel.fromJson(v))
              .toList(growable: true == growable);

  static Map<String, OrganizationCustomerProfileModel> mapFromJson(
      Map<String, dynamic> json) {
    final map = <String, OrganizationCustomerProfileModel>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) =>
          map[key] = OrganizationCustomerProfileModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of OrganizationCustomerProfileModel-objects as value to a dart map
  static Map<String, List<OrganizationCustomerProfileModel>> mapListFromJson(
    Map<String, dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = OrganizationCustomerProfileModel.listFromJson(v,
...
class OrganizationCustomerProfileModelTypeEnum {
  ...
  static List<OrganizationCustomerProfileModelTypeEnum> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ? null
              : <OrganizationCustomerProfileModelTypeEnum>[]
          : json
              .map((value) =>
                  OrganizationCustomerProfileModelTypeEnum.fromJson(value))
              .toList(growable: true == growable);
}
...
class OrganizationCustomerProfileModelTypeEnumTypeTransformer {
  ...
  factory OrganizationCustomerProfileModelTypeEnumTypeTransformer() =>
      _instance ??= OrganizationCustomerProfileModelTypeEnumTypeTransformer._();
  ...
  OrganizationCustomerProfileModelTypeEnum decode(dynamic data,
      {bool allowNull}) {
    switch (data) {
      case r'STRIPE':
        return OrganizationCustomerProfileModelTypeEnum.STRIPE;
      case r'SHOPIFY':
        return OrganizationCustomerProfileModelTypeEnum.SHOPIFY;
      case r'OFFLINE':
        return OrganizationCustomerProfileModelTypeEnum.OFFLINE;
      default:
        if (allowNull == false) {
