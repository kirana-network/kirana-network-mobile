...
class TripModel {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is TripModel &&
     other.id == id &&
  ...
  static List<TripModel> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <TripModel>[]
      : json.map((v) => TripModel.fromJson(v)).toList(growable: true == growable);
  ...
  static Map<String, List<TripModel>> mapListFromJson(Map<String, dynamic> json, {bool emptyIsNull, bool growable,}) {
    final map = <String, List<TripModel>>{};
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = TripModel.listFromJson(v, emptyIsNull: emptyIsNull, growable: growable);
      });
    }
    return map;
  }
...
class TripModelTripStatusEnum {
  ...
  static List<TripModelTripStatusEnum> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <TripModelTripStatusEnum>[]
      : json
...
class TripModelTripStatusEnumTypeTransformer {
  ...
  factory TripModelTripStatusEnumTypeTransformer() => _instance ??= TripModelTripStatusEnumTypeTransformer._();
  ...
  TripModelTripStatusEnum decode(dynamic data, {bool allowNull}) {
    switch (data) {
      case r'PENDING': return TripModelTripStatusEnum.PENDING;
      case r'SCHEDULED': return TripModelTripStatusEnum.SCHEDULED;
      case r'ON_ROUTE': return TripModelTripStatusEnum.ON_ROUTE;
      case r'COMPLETED': return TripModelTripStatusEnum.COMPLETED;
      case r'CANCELLED': return TripModelTripStatusEnum.CANCELLED;
      default:
        if (allowNull == false) {
...
class TripModelTripTypeEnum {
  ...
  static List<TripModelTripTypeEnum> listFromJson(List<dynamic> json, {bool emptyIsNull, bool growable,}) =>
    json == null || json.isEmpty
      ? true == emptyIsNull ? null : <TripModelTripTypeEnum>[]
      : json
...
class TripModelTripTypeEnumTypeTransformer {
  ...
  factory TripModelTripTypeEnumTypeTransformer() => _instance ??= TripModelTripTypeEnumTypeTransformer._();
  ...
  TripModelTripTypeEnum decode(dynamic data, {bool allowNull}) {
    switch (data) {
      case r'NONE': return TripModelTripTypeEnum.NONE;
      case r'DELIVERY': return TripModelTripTypeEnum.DELIVERY;
      default:
        if (allowNull == false) {
          throw ArgumentError('Unknown enum value to decode: $data');
        }
