...
class UserProfileModel {
  ...
  @override
  String toString() =>
      'UserProfileModel[firstName=$firstName, lastName=$lastName, email=$email, id=$id, createdAt=$createdAt, updatedAt=$updatedAt, createdBy=$createdBy, updatedBy=$updatedBy, extra=$extra]';
  ...
  static List<UserProfileModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <UserProfileModel>[]
          : json
              .map((v) => UserProfileModel.fromJson(v))
  ...
  static Map<String, UserProfileModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = UserProfileModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of UserProfileModel-objects as value to a dart map
  static Map<String, List<UserProfileModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = UserProfileModel.listFromJson(v,
