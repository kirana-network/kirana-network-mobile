...
class ListOfTripsModel {
  ...
  static List<ListOfTripsModel> listFromJson(
    List<dynamic> json, {
    bool emptyIsNull,
    bool growable,
  }) =>
      json == null || json.isEmpty
          ? true == emptyIsNull
              ...
              : <ListOfTripsModel>[]
          : json
              .map((v) => ListOfTripsModel.fromJson(v))
  ...
  static Map<String, ListOfTripsModel> mapFromJson(Map<String, dynamic> json) {
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach(
          (String key, dynamic v) => map[key] = ListOfTripsModel.fromJson(v));
    }
    return map;
  }

  // maps a json object with a list of ListOfTripsModel-objects as value to a dart map
  static Map<String, List<ListOfTripsModel>> mapListFromJson(
    ...
    if (json != null && json.isNotEmpty) {
      json.forEach((String key, dynamic v) {
        map[key] = ListOfTripsModel.listFromJson(v,
