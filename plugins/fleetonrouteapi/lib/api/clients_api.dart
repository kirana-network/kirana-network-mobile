...
class ClientsApi {
  ...
  ///
  /// * [String] range:
  Future<Response> listClientsWithHttpInfo(String filter,
      {String sort, String range}) async {
  ...
  ///
  /// * [String] range:
  Future<ListOfClientsModel> listClients(String filter,
      {String sort, String range}) async {
    final response =
        await listClientsWithHttpInfo(filter, sort: sort, range: range);
