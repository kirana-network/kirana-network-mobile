...
/// tests for TripsApi
void main() {
  final instance = TripsApi();

  group('tests for TripsApi', () {
    // createTrip
    //
    ...
    test('test createTripNote', () async {
      // TODO
    });
    ...
    test('test deleteTripNote', () async {
      // TODO
    });
