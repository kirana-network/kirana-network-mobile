...
/// tests for GpsunitsApi
void main() {
  final instance = GpsunitsApi();

  group('tests for GpsunitsApi', () {
    // createGpsUnit
    //
    //Future<GPSUnitModel> createGpsUnit(String userProfileId, GPSUnitModel gPSUnitModel) async
    test('test createGpsUnit', () async {
      // TODO
    });
    ...
    test('test retrieveGpsUnit', () async {
      // TODO
    });
